...
def reset_result_matrix():
    #Reinicia la matriz de solución
    column = []
...
def sum_without_none(iterable):
    #Realiza sumas sin ningun numero cero
    result = 0
...
def insert_artificial_destination():
    # Inserta los diferentes almacenes
...
def difference_lower_costs(iterable):
    # Diferencia entre todos cual es el que tiene el menor costo
    best = min(iterable)
...
def main():
    # Establece la matriz y usa las diferentes funciones, al final imprime el resultado
